...
public:
	explicit exult_exception(std::string what_arg, const char* sourcefile = nullptr, int line = 0)
...
public:
	explicit file_exception(std::string what_arg, const char* sourcefile, int line)
...
public:
	explicit file_open_exception(const std::string& file, const char* sourcefile, int line)
...
public:
	explicit file_write_exception(const std::string& file, const char* sourcefile, int line)
...
public:
	explicit file_read_exception(const std::string& file, const char* sourcefile, int line)
			: file_exception("Error reading from file " + file, sourcefile, line) {}
};

class wrong_file_type_exception : public file_exception {
public:
	explicit wrong_file_type_exception(const std::string& file, const std::string& type, const char* sourcefile, int line)
...
#define file_write_exception(file) file_write_exception(file, __FILE__, __LINE__)
