...
public:
	explicit exult_exception(std::pmr::string& what_arg, const char* sourcefile = nullptr, int line = 0)
			: what_(std::move(what_arg)), errno_(errno), sourcefile_(sourcefile), line_(line) {}

	explicit exult_exception(std::string_view what_arg, const char* sourcefile = nullptr, int line = 0)
			: what_(what_arg), errno_(errno), sourcefile_(sourcefile), line_(line) {}
...
public:
	explicit file_exception(std::pmr::string what_arg, const char* sourcefile, int line)
...
public:
	explicit file_open_exception(const std::pmr::string& file, const char* sourcefile, int line)
...
public:
	explicit file_write_exception(const std::pmr::string& file, const char* sourcefile, int line)
			: file_exception("Error writing to file " + file, sourcefile, line) {}
};
...
public:
	explicit file_read_exception(const std::pmr::string& file, const char* sourcefile, int line)
			: file_exception("Error reading from file " + file, sourcefile, line) {}
};

class wrong_file_type_exception : public file_exception {
public:
	explicit wrong_file_type_exception(const std::pmr::string& file, const std::pmr::string& type, const char* sourcefile, int line)
...
#define file_write_exception(file) file_write_exception(std::pmr::string(file), __FILE__, __LINE__)

#define file_read_exception(file) file_read_exception(std::pmr::string(file), __FILE__, __LINE__)

#define wrong_file_type_exception(file, type) wrong_file_type_exception(std::pmr::string(file), type, __FILE__, __LINE__)
