...
void Image_window::show_scaled8to16_2xSaI(
	...
	Scale_2xSaI<unsigned char, uint16, Manip8to16>(
			static_cast<uint8*>(draw_surface->pixels), x, y, w, h, ibuf->line_width, ibuf->height,
			static_cast<uint16*>(inter_surface->pixels), inter_surface->pitch / inter_surface_format->bytes_per_pixel, manip);
}
...
void Image_window::show_scaled8to555_2xSaI(
	...
	Scale_2xSaI<unsigned char, uint16, Manip8to555>(
			static_cast<uint8*>(draw_surface->pixels), x + guard_band, y + guard_band, w, h, ibuf->line_width, ibuf->height,
			static_cast<uint16*>(inter_surface->pixels), inter_surface->pitch / inter_surface_format->bytes_per_pixel, manip);
}
...
void Image_window::show_scaled8to32_2xSaI(
	...
	Scale_2xSaI<unsigned char, uint32, Manip8to32>(
			static_cast<uint8*>(draw_surface->pixels), x + guard_band, y + guard_band, w, h, ibuf->line_width, ibuf->height,
			static_cast<uint32*>(inter_surface->pixels), inter_surface->pitch / inter_surface_format->bytes_per_pixel, manip);
}
