...
void Game_window::read_saveinfo(IDataSource* in, SaveGame_Details& details, std::vector<SaveGame_Party>& party) {
...
void Game_window::get_saveinfo(std::unique_ptr<Shape_file>& map, SaveGame_Details& details, std::vector<SaveGame_Party>& party) {
	{
		IFileDataSource ds(GSAVEINFO);
		if (ds.good()) {
