...
public:
	...
	PageTurnEffect(uint64 duration, TileRect effectRect, uint8 lineColour = 0xff, bool alternativeEffect = false)
			: BufferTransitionEffect(duration, effectRect), forward(true), lineColour(lineColour),
